...
```sh
claude mcp add weavatrix -- npx -y weavatrix@1.17.5 mcp .
```
...
recognize Rust `impl Trait for Type` as an explicit implementation signal,
without mistaking inherent `impl Type` for one. They
